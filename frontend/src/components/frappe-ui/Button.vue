...
const buttonClasses = computed(() => {
	let solidClasses = {
		...
		green: 'text-[#fff] bg-[#00AA80] hover:bg-[#00AA80]/80 active:bg-[#00AA80]',
			...
			purple: 'text-white bg-purple-600 hover:bg-purple-500 active:bg-purple-700',
	}[props.theme]
	...
	let subtleClasses = {
		...
		green: 'text-green-800 bg-surface-green-2 hover:bg-green-200 active:bg-green-300',
			...
			purple: 'text-purple-700 bg-purple-100 hover:bg-purple-200 active:bg-purple-300',
	}[props.theme]
	...
	let outlineClasses = {
		...
		purple: 'text-purple-700 bg-surface-white border border-purple-200 hover:border-purple-400 active:border-purple-400 active:bg-purple-300',
	}[props.theme]
	...
	let ghostClasses = {
		...
		green: 'text-green-800 bg-transparent hover:bg-green-200 active:bg-green-300',
			...
			purple: 'text-purple-700 bg-transparent hover:bg-purple-100 active:bg-purple-200',
	}[props.theme]
