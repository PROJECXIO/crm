    ...
    <template #body="{ isOpen }">
      ...
      >
        <button
          ...
          :data-index="idx"
          type="button"
          class="group flex h-8 w-full items-center rounded px-2 text-left hover:bg-bg-green hover:text-white"
...
const props = withDefaults(defineProps<CustomTimePickerProps>(), {
  value: '',
  modelValue: '',
  interval: 15,
  options: () => [],
